...
class StatusMsg(Enum):
    ...
    DIREMODEL_INFERENCE_ERROR = '方向分類模型推論錯誤'
    PAPEMODEL_INFERENCE_ERROR = '紙張分割模型推論錯誤'
    TABLMODEL_INFERENCE_ERROR = '表格線條模型推論錯誤'

    TABLE_EMPTY_ROWS = '找不到水平線'
    TABLE_EMPTY_COLS = '找不到垂直線'
